import { ShoppingCart, Menu, History, Shield, Package, LogOut, UtensilsCrossed, Receipt, Users, BarChart3, LayoutDashboard, Store, UtensilsCrossed as ProductIcon, Crown, Megaphone, CalendarClock, CreditCard, Truck, Settings as SettingsIcon, ShoppingBasket, LineChart } from "lucide-react";
...
export function AppSidebar() {
  ...
  return (
    <Sidebar collapsible="icon">
      <SidebarHeader className="border-b h-14 justify-center py-0">
